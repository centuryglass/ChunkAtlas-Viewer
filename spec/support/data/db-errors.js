module.exports = {
    ...
    "INVALID_ID": [
        {
            ...
            "severity": "ERROR",
            "code": "23514",
            "detail": "Failing row contains (INVALID, 1, null, 2020-02-05 23:35:28.602726).",
            "schema": "public",
            "table": "regions",
        ...
        },
        {
            ...
            "severity": "ERROR",
            "code": "23514",
            "detail": "Failing row contains (INVALID, d, /uri.png, 2020-02-05 23:35:28.604681).",
            "schema": "public",
            "table": "map_types",
        ...
        },
        {
            ...
            "severity": "ERROR",
            "code": "23514",
            "detail": "Failing row contains (INVALID, displayName, /uri.png, 2020-02-05 23:35:28.605606).",
            "schema": "public",
    ...
    "EMPTY_STRING": [
        {
            ...
            "severity": "ERROR",
            "code": "23514",
            "detail": "Failing row contains (empty_region, , null, 2020-02-05 23:35:28.61024).",
            "schema": "public",
            "table": "regions",
        ...
        },
        {
            ...
            "severity": "ERROR",
            "code": "23514",
            "detail": "Failing row contains (empty_type, , null, 2020-02-05 23:35:28.611139).",
            "schema": "public",
            "table": "map_types",
    ...
    "OTHER_CONSTRAINT": [
        ...
        },
        {
            ...
            "severity": "ERROR",
            "code": "23514",
            "detail": "Failing row contains (reg, typ, Test, 2020-02-05 23:35:28.614289, fffffg, null).",
            "schema": "public",
            "table": "key_items",
